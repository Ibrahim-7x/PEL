...
<section class="py-5 bg-light">
    <div class="container">
        ...
        <form action="{{ route('management') }}" method="POST" class="p-4 shadow rounded bg-white">
            @csrf
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input name="service_center_id" id="service_center" class="form-control" readonly>
                </div>
                <div class="col-md-6">
                    <label for="complaint_date" class="form-label">Complaint Escalation Date</label>
                    <input type="date" 
                        class="form-control" 
                        name="complaint_date" 
                        id="complaint_date" 
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="aging" class="form-control" value="{{ $aging ?? '' }}">
                </div> 
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" 
                        ...
                        name="name" 
                        id="name" 
                        value="{{ auth()->user()->role === 'Agent, Management' ? auth()->user()->name : '' }}" 
                        readonly>
                </div>
                <div class="col-md-6">
