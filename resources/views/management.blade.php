        ...
        <form id="ticketSearchForm" class="p-4 shadow rounded bg-white">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control" name="complaint_escalation_date" id="complaint_escalation_date" readonly>
                </div>
                <div class="col-md-3">
            ...
            document.getElementById("searchBtn").addEventListener("click", function () {
                ...
                .then(data => {
                    if (data.error) {
                        ...
                        document.getElementById("complaint_escalation_date").value = data.complaint_escalation_date ?? '';
                ...
                @if(empty($ici))
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            ...
                            {{-- Search form --}}
                            <form id="ticketSearchForm" method="GET" action="{{ route('management.index') }}" class="row g-2">
                                <div class="col-auto">
