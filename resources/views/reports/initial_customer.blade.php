...
<style>
    ...
    .export-form-card {
        ...
        border-radius: 15px;
        padding: 3rem;
        box-shadow: 0 8px 32px rgba(123, 143, 161, 0.15);
    ...
    .form-control {
        border: 2px solid rgba(123, 143, 161, 0.3);
        border-radius: 10px;
        padding: 0.8rem 1rem;
        font-size: 1rem;
...
<div class="export-hero">
    <div class="container">
        <div class="text-center">
            ...
            <h1 class="export-title">Initial Customer Information Export</h1>
            <p class="export-description">Generate comprehensive Initial Customer Information reports for your selected date range</p>
        </div>
    </div>
</div>
