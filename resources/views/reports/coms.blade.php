...
@section('title', 'Export COMS')

@section('title', 'COMS Export')
...
<div class="export-hero">
    <div class="container">
        <div class="text-center">
            ...
            <h1 class="export-title">COMS Export</h1>
            <p class="export-description">Generate comprehensive COMS reports for your selected date range</p>
        </div>
    </div>
</div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="export-form-card">
                <form method="POST" action="{{ route('export.coms.download') }}">
                    @csrf
                    <div class="row g-4">
                        <div class="col-md-6">
